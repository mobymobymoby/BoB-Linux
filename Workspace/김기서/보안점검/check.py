...
def logo():
    print(" _     _                     ____                       _ _            ____ _               _    ")
    print("| |   (_)_ __  _   ___  __  / ___|  ___  ___ _   _ _ __(_) |_ _   _   / ___| |__   ___  ___| | __")
    print("| |   | | '_ \| | | \ \/ /  \___ \ / _ \/ __| | | | '__| | __| | | | | |   | '_ \ / _ \/ __| |/ /")
    print("| |___| | | | | |_| |>  <    ___) |  __/ (__| |_| | |  | | |_| |_| | | |___| | | |  __/ (__|   < ")
    print("|_____|_|_| |_|\__,_/_/\_\\  |____/ \___|\___|\__,_|_|  |_|\__|\__, |  \____|_| |_|\___|\___|_|\_\\")
    print("                                                               |___/                              ")
    print("BoB Linux Security Check에 오신것을 환영합니다.\n")
    print("본 프로그램은 KISA에서 발간한")
    print("\"주요통신기반시설 기술적 취약점 진단 및 평가 가이드\"를 토대로")
