...
void training_dd(void)
{
    ...
    printf("\"dd\"는 'Data Description'을 의미하며\n");
    ...
    printf("보통 'if=대상디스크/파티션 of=저장파일 단위명=사이즈' 를 입력해 사용합니다.\n");
    next_line();
	...
	printf("\n\n\"ls -al\" 명령을 통해 확인해보면\n\n");
    printf("현재 디렉토리에 'dir1' 디렉토리와 'dir2' 디렉토리가 있고\n");
