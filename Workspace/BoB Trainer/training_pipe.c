...
{   
    ...
    printf("[실습] \"touch test1; cat > test1; cat test1\"을 입력하시고 아무 내용 입력한 뒤 Ctrl + d로 저장하세요.\n");
    ...
    printf("앞에 명령어의 실행 결과로 나온 출력 결과를 -> 뒤에 실행하는 명령어의 입력 값으로 넣어준다는 말입니다.\n\n");
    printf("앞에서 밀가루 반죽을 모양틀을 이용해 모양을 떠서 나온 결과인 별모양 밀가루 반죽을\n");
    printf("-> 뒤에서 진행할 오븐에 밀가루 반죽을 넣어 빵 굽는 작업에 별모양 밀가루 반죽을 넣는다 라고 이해하시면 됩니다.\n");
    next_line();
    ...
    printf("\"cat\"으로 .bashrc 파일의 내용을 출력하는데, 바로 출력하지 않고 \"more 명령어\"의 입력으로 보내어");
