...
void training_virtual_console(void)
{
	...
	printf("방법을 몰라서 못 띄우는 경우가 대다수 일 것입니다.\n");
	next_line();
	...
	printf("\"Ctrl + Alt + F1\"이 기본 창으로 전환하는 단축키이며\n");
	printf("\"Ctrl + Alt + F6\"까지 총 6개의 텍스트 기반의 로그인 창을 제공합니다.\n");
	printf("( X-Window에서는 'Alt' 키가 특수한 기능으로 사용되기에 'Ctrl' 키와 조합하여 사용해야 합니다.\n");
	next_line();
	...
	printf("이미 지나간 작업의 내용을 볼 수 없었지만, 최근 배포판들은 그래픽카드 메모리를 활용하여\n");
