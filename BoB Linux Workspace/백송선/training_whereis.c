...
void training_whereis(void)
{
    ...
    next_line();
    printf("'-b' 옵션을 이용하여 \"locate\" 명령어의 실행 파일 위치만 출력하세요.\n");
    printf("사용법 : whereis [옵션] [검색할 명령어]\n");
    just_run_command("whereis -b locate");
    next_line();
    printf("잘 따라하셨다면 \"locate: /usr/bin/locate\" 라고 출력되었을 것입니다.\n");
    printf("(혹은 파일이 들어있는 위치)\n");
    printf("\"locate\" 명령어의 실행파일 위치는 'root' 밑에 'usr' 밑에 'bin' 밑에 위치 하고 있다고 출력해주고 있습니다.\n");
    next_line();
    printf("이번에는 '-m' 옵션을 이용하여 \"locate\" 명령어의 매뉴얼 파일 위치만 출력하세요.\n");
    printf("사용법 : whereis [옵션] [검색할 명령어]\n");
    just_run_command("whereis -m locate");
    next_line();
    printf("잘 따라하셨다면 \"locate: /usr/share/man/man1/locate.1.gz\" 라고 출력되었을 것입니다.\n");
    printf("(혹은 파일이 들어있는 위치)\n");
