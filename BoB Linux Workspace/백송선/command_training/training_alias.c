...
void training_alias(void)
{
    ...
    next_line();
    printf("\"alias ls='ls -al'\"을 입력해보세요.\n");
    ...
    next_line();
    printf("\"alias whoami\"을 입력하여 \"whoami\"가 별명인지 명령어인지 확인해보세요.\n");
    ...
    next_line();
    printf("\"alias mkfile='touch'\"를 입력하여 'mkfile'을 입력시 \"touch\" 명령어가 실행되게 해보세요.\n");
    printf("사용법 : alias [별명]='[실행될 명령어]'\n");
    fake_run_command("alias mkfile='touch'");
    system("alias mkfile=\'touch\'");
    printf("\n잘 입력하셨다면 이제 \"mkfile\" 별명을 이용하여 파일을 생성할 수 있을 것입니다.\n");
    next_line();
    ...
    next_line();
    printf("\".bashrc\"와 \".bash_profile\" 파일은 앞에 ' . ' 이 붙어있는 파일로, 기본적으로 숨긴 파일입니다.\n");
    next_line();
    ...
    printf("\"alias\" 명령어와 해당 별명을 제거하는 \"unalias\" 명령어에 대해 배워보았습니다.\n");
    next_line();
    printf("그리고 지정한 별명을 계속 사용하려면\n");
    printf("\"~/.bashrc\" 혹은 \"~/.bash_profile\"이라는 숨긴 파일에 저장해두고 시스템을 재부팅해야 하는 것을 배웠습니다.\n");
    next_line();
