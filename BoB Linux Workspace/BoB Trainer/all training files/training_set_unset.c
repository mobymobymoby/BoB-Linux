...
void training_set_unset(void)
{
	...
	next_line();
	printf("unset은 선언된 변수를 제거하는 명령어입니다.\n");
	next_line();
	...
	printf("[실습] 'set'을 입력하면 현재 선언된 많은 변수들이 출력될 것 입니다.\n'set'을 입력해보세요\n");
	fake_run_command("set");
	...
	printf("마지막 줄에 방금 입력한 'myVal=value'가 확인됩니다.\n");
	next_line();
	printf("이제 unset 명령어를 사용해 셸 변수를 해제해봅시다.\n[실습] unset 명령어를 입력해 'myVal' 변수를 제거해보세요.\n");
