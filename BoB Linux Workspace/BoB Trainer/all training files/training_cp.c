...
void training_cp(void)
{
    ...
    next_line();
    printf("[옵션]은 선택 사항이며, 해당 명령어에 지정할 옵션을 적는 부분이고\n");
    ...
    printf("[실습] \"cp\" 명령어를 이용하여 현재 디렉토리의 파일 'file1'을 'file2'로 복사해보세요.\n");
    printf("사용법 : cp [원본 파일] [대상 파일]\n");
    run_command("cp file1 file2");
    next_line();
    
    printf("다음은 \"ls -al\"을(를) 실행한 결과로, 'file1'이 'file2'로 복사된 것을 확인하실 수 있습니다.\n\n");
    system("ls -al");
    ...
    printf("[실습] \"cp\" 명령어에 '-i' 옵션을 사용해 'dir1/file1'을 현재 폴더의 'file1'(으)로 복사해보세요.\n");
    ...
    printf("[실습] \"cp\" 명령어와 '-r' 옵션을 사용해 'dir1'을 'dir2'로 현재 디렉토리에 복사해보세요.\n");
    ...
    printf("위의 각각의 결과들을 보면, 'dir1'이 'dir2'(으)로 복사되었고\n");
