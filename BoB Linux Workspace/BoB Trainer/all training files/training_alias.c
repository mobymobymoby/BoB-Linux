...
void training_alias(void)
{
    ...
    next_line();
    printf("[실습] \"mkfile test1\"라고 입력하여 'test1 파일'을 만들어보세요.\n");
    fake_run_command("mkfile test1");
    system("touch test1");
    printf("\n이제 'test1 파일'이 만들어졌을 것입니다.\n");
    next_line();
    printf("\"ls\" 명령어를 이용하여 'test1 파일'이 만들어졌는지 확인해보세요.\n");
    fake_run_command("ls");
    system("ls -al");
    ...
    printf("그러므로 \"~/.bashrc\" 파일이나 자신이 사용하는 Shell에 'rc'가 붙은 파일에 저장하는 것을 추천드립니다.\n");
    next_line();
