...
void training_comm(void)
{
    ...
    printf("'test1' 파일과 'test2' 파일 모두 들어있는 내용이기 때문에 Tab 키를 두번 한 세 번째 열에 입력됩니다.\n");
    next_line();
    printf("'five'는 'test1' 파일에만 들어있는 내용이기 때문에 첫 번째 열에 입력됩니다.\n");
    next_line();
    printf("'six'와 'seven'은 'test2' 파일에만 들어있는 내용이기 때문에\n");
    printf("Tab 키를 한번 한 두 번째 열에 입력됩니다.\n");
    next_line();
    ...
    next_line();
    printf("'test1' 파일과 'test2' 파일을 '-1' 옵션을 이용하여 비교해보세요.\n");
