...
void training_comm(void)
{
    ...
    printf("\"diff\" 명령어와는 다르게 \"동일 행끼리만 단순 비교\"합니다.\n");
    next_line();
    ...
    next_line();
    printf("\"comm\" 명령어를 옵션을 넣지 않고 이용하여 'test1 파일'과 'test2 파일'의 내용을 비교해보세요.\n");
    ...
    printf("\n해석하자면 이렇습니다.\n");
    next_line();
    printf("'own', 'two', 'three', 'four'는 'test1 파일'과 'test2 파일' 모두 들어있는 내용이기 때문에 Tab 키를 두번 한 세 번째 열에 입력됩니다.\n");
    next_line();
    printf("'five'는 'test1 파일'에만 들어있는 내용이기 때문에 첫 번째 열에 입력됩니다.\n");
    next_line();
    printf("'six'와 'seven'은 'test2 파일'에만 들어있는 내용이기 때문에 Tab 키를 한번 한 두 번째 열에 입력됩니다.\n");
    next_line();
    printf("\"comm\" 명령어의 자주 쓰이는 옵션들은 다음과 같습니다.\n");
    next_line();
    printf("-1 : 두 개의 파일을 비교하지만, 첫 번째 파일에만 있는 내용은 출력하지 않고 두 파일 모두 있거나 두 번째 파일에 있는 내용은 출력합니다.\n");
    printf("-2 : 두 개의 파일을 비교하지만, 두 번째 파일에만 있는 내용은 출력하지 않고 두 파일 모두 있거나 첫 번째 파일에 있는 내용은 출력합니다.\n");
    printf("-3 : 두 개의 파일을 비교하지만, 두 파일 모두에 있는 내용은 출력하지 않고 첫 번째 파일에만 있거나 두 번째 파일에만 있는 내용은 출력합니다.\n");
    next_line();
    printf("'test1 파일'과 'test2 파일'을 가지고 옵션들을 차례대로 실습해보겠습니다.\n");
    next_line();
    printf("'test1 파일'과 'test2 파일'을 '-1' 옵션을 이용하여 비교해보세요.\n");
    ...
    next_line();
    printf("이번에는 'test1 파일'과 'test2 파일'을 '-2' 옵션을 이용하여 비교해보세요.\n");
    printf("사용법 : comm [옵션] [비교할 파일1] [비교할 파일2]\n");
    ...
    next_line();
    printf("마지막으로 'test1 파일'과 'test2 파일'을 '-3' 옵션을 이용하여 비교해보세요.\n");
    printf("사용법 : comm[옵션] [비교할 파일1] [비교할 파일2]\n");
    ...
    next_line();
    printf("\"comm\" 명령어의 옵션은 위에 나온 것들 말고도 여러가지가 있습니다.\n");
    next_line();
