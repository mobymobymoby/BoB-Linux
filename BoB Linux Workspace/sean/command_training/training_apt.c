...
void training_apt(void)
{
    ...
    next_line();
    printf("만약 특정 프로그램이 의존하는 다른 프로그램들이 많다면 사용자 입장에서는 엄청 힘들 것입니다.\n");
    ...
    printf("sudo apt list --upgradable      : 설치된 패키지 중 업그레이드 대상 패키지 목록을 조회합니다.\n");
    printf("                                  (wc -l 명령어를 pipe로 이어주면 숫자로 표기됩니다.)\n");
    ...
    printf("학습의 진행을 위해 'y'키 혹은 'n'키를 누르라는 메세지가 나오면 'n'을 입력해주세요.\n");
    ...
    printf("\n잘 입력하셨다면 gcc가 이미 설치되어 있다고 뜰 것입니다.\n");
    ...
    printf("\n방금 실습한 명령어로 gcc 패지를 제거하실 수 있습니다.\n");
    next_line();
