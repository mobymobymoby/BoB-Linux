...
void training_linux_basic(void)
{
    ...
    printf("운영 체제의 커널인 '리눅스 커널'에 기반을 두고, 'Unix(유닉스)'라는 운영 체제를 모델로 하여 만든 \n");
    ...
    printf("하지만, 위의 3가지는 리눅스 배포판들을 크게 계열로 나눈 것이며\n");
    printf("리눅스 배포판들은 수도 없이 많고 현재도 많은 사용자들이 변형하여 사용하거나 배포하고 있습니다.\n\n");
    ...
    printf("그런 사람들에게 \"Linux\"라는 운영 제네는 생소하고 어렵고 새로운 단어일 것입니다.\n\n");
