...
void training_intro()
{
    ...
    printf("[사용자 계정 이름] : 1.에 해당하는 부분에는 사용자의 계정 이름이 들어갑니다.\n");
    printf("'localhost' : 2.에 해당하는 부분은 '호스트'의 이름이 들어갑니다.\n");
    printf("'/home/[사용자 계정 이름]/tr' : 현재 작업 디렉토리가 표시됩니다. 본 트레이닝 기능에서의 기본 디렉토리는 /home/[사용자 계정 이름]/tr입니다.\n");
    printf("'$' : 현재 사용자가 루트 계정이라면 #으로, 아니라면 $으로 표시됩니다.\n");
    next_line();
    system("clear");
